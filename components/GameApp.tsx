...
export function GameApp() {
  ...
  return <>
    <GameScreen state={store.game} events={store.events} animationSpeed={store.settings.speed} interactionLocked={store.game.phase === "resolving" && !store.game.pending} onCommand={store.command} onOpenStocks={() => store.setStocks(true)} onOpenSettings={() => store.setSettingsOpen(true)} onUse={store.useEffect} />
