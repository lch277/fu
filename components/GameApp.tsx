...
export function GameApp() {
  ...
  return <>
    <GameScreen state={store.game} events={store.events} onCommand={store.command} onOpenInventory={() => store.setInventory(true)} onOpenStocks={() => store.setStocks(true)} />
